cdef extern from "libxtrx/xtrx_api.h":
    ...
    сtypedef struct gtime_data:
        uint32_t sec
	    uint32_t nsec

    сtypedef struct gtime_data gtime_data_t
    ...
    сtypedef xtrx_clock_source structxtrx_clock_source_t
    ...
    ctypedef struct xtrx_device_info:
	    ...
	    char serial[32]
	    char devid[64]
    сtypedef xtrx_device_info xtrx_device_info_t
    ...
    ctypedef enum xtrx_channel:
	    ...
	    XTRX_CH_ALL = ~0U
    сtypedef xtrx_channel xtrx_channel_t
